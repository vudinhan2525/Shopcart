...
function HeaderComponent() {
  ...
  return (
    <div className="flex py-2 backdrop-blur-md bg-[#F5F5F7]/70 dark:bg-dark-flat/80 items-center shadow-sm fixed top-0 right-0 left-0 z-50">
      <Link to="/" className="basis-1/4">
        <div className="w-52 mx-auto h-12 relative">
          <div className="w-12 h-12 bg-no-repeat bg-contain ml-12" style={{ backgroundImage: `url(${logoimg})` }}></div>
          <p className="absolute top-[50%] translate-y-[-50%] right-[5%] font-bold text-xl text-primary-color dark:text-[#e8e5e5]">
            ShopCart
          </p>
        </div>
      </Link>
