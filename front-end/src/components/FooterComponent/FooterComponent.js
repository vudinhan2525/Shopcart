      ...
      <div className="flex gap-5 px-10 mt-12 pb-11 dark:text-dark-text">
        <div className="basis-[35%] flex flex-col pr-8 ">
          <div className="w-28 h-16 relative">
            <div
              className="w-12 h-12 bg-no-repeat bg-contain ml-3"
              style={{ backgroundImage: `url(${logoimg})` }}
            ></div>
            <p className="absolute top-[40%] dark:text-dark-text translate-y-[-50%] right-[-65%] font-bold text-2xl text-primary-color">
              ShopCart
            </p>
          </div>
