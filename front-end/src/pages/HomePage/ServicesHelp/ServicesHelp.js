  ...
  return (
    <div className="mb-[100px]">
      ...
      <div className="grid grid-cols-3 mt-8 gap-6">
        <div className="">
          <div className="bg-[#F5F6F6] px-10 py-10 rounded-t-xl">
            <header className="text-[22px] leading-[30px] w-[70%] text-gray-800 font-bold">
              Frequently Asked Questions
            </header>
            <p className="mt-4 leading-[28px]  w-[70%]">Updates on safe Shopping in our Stores</p>
          </div>
