...
export default function ChatList({ setIsLoading, chatList, chatSelected, setChatSelected }) {
  return (
    <div className="flex flex-col mt-14">
      ...
      {chatList.length === 0 && (
        <div className="text-center px-6 text-gray-700 font-bold mt-20">This shop currently doesn't have any chat</div>
      )}
    </div>
  );
}
